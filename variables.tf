...
variable "environment" {
  type        = string
  description = "(Optional) Environment of resources"
  default     = "development"
}
...
variable "public_subnets" {
  type        = map(string)
  description = "(Optional) Map of subnets to create with CIDR blocks. Key will be used as subnet name with prefix. Default: {subnet-1 ="
  default = {
